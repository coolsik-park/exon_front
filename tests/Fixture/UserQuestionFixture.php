...
class UserQuestionFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'users_hp' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'users_email' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'title' => ['type' => 'string', 'length' => 128, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '문의 제목', 'precision' => null],
        'question' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '문의 내용', 'precision' => null],
        'answer' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '문의 답변', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'fk_user_question_faq_category1' => ['type' => 'foreign', 'columns' => ['faq_category_id'], 'references' => ['faq_category', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_user_question_managers1' => ['type' => 'foreign', 'columns' => ['managers_id'], 'references' => ['managers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_user_question_users1' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
