...
class UserQuestionFilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_path' => ['type' => 'string', 'length' => 2048, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
...
A: 답변 파일', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'fk_user_question_files_user_question1' => ['type' => 'foreign', 'columns' => ['user_question_id'], 'references' => ['user_question', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
