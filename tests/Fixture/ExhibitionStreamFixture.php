...
class ExhibitionStreamFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stream_key' => ['type' => 'string', 'length' => 64, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '스트림 키', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-08-06 01:30:17',
                'modified' => '2021-08-06 01:30:17',
            ],
        ];
        parent::init();
    }
