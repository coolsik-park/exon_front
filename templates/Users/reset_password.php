            ...
            <div class="log-step-page log log-step-03">
                ...
                <div class="mbr-form">
                    <div class="item-row">
                        ...
                        <div class="col-dd">
                            <input type="password" id="pwd" name="pwd" class="full" label="" title="비밀번호" placeholder="최소 8자 이상" autocomplete="off" >
                        </div>
                    </div>
                    <div class="item-row">
                        <div class="col-dt">비밀번호 확인</div>
                        <div class="col-dd">
                            <input type="password" id="pwd_confirm" name="pwd_confirm" class="full" label="" title="비밀번호 확인" placeholder="최소 8자 이상" autocomplete="off" >
                        </div>
                    </div>
                </div>
                <div class="btn-btm">
