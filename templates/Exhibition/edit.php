            ...
            <div class="section1">
                ...
                <div class="sect2">
                    ...
                    <div class="date-sett-wp">
                        <div class="date-sett">
                            <?php echo $this->Form->control('apply_sdate', ['step' => null, 'id' =>'apply_sdate', 'label' => '시작 일시', 'placeholder' => '시작날짜', 'class' => 'date-date', 'style' => 'width:370px; height:48.52px']); ?>
                        </div>
                        <div class="date-sett">
                            <?php echo $this->Form->control('apply_edate', ['step' => null, 'id' =>'apply_edate', 'label' => '종료 일시', 'class' => 'date-date', 'style' => 'width:370px; height:48.52px']); ?>
                        </div>               
                    </div>
                </div>
                <div class="sect2">
                    ...
                    <div class="date-sett-wp">
                        <div class="date-sett">
                            <?php echo $this->Form->control('sdate', ['step' => null, 'id' =>'sdate', 'label' => '시작 일시', 'placeholder' => '시작날짜', 'class' => 'date-date', 'style' => 'width:370px; height:48.52px']); ?>
                        </div>
                        <div class="date-sett">
