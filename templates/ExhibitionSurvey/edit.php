...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $exhibitionSurvey->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $exhibitionSurvey->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="exhibitionSurvey form content">
            ...
            <fieldset>
                <legend><?= __('Edit Exhibition Survey') ?></legend>
                <?php
