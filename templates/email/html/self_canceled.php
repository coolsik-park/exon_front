...
<body>
    ...
    <div style="max-width: 700px;margin: 0 auto;border: 1px solid #dbdbdb;border-radius: 0.938rem;">
        ...
        <div style="padding: 1.875rem">
            ...
            <p style="margin-top: 1.875rem;font-size: 1.875rem;line-height: 1.33;font-weight: 700;">참가신청 취소가 완료되었습니다.</p>
            ...
            <div>
                ...
                <p style="margin-top: 1.875rem;font-size: 0.875rem;color: #afafaf;line-height: 1.45;">참가 신청 취소가 완료되었습니다. 환불금액은 상황에 따라 다를 수 있습니다.</p>
            </div>
        </div>
    </div>
