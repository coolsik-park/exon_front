    ...
    <div class="section-webinar4">
        <div class="webinar-cont">
            ...
            <div class="sect3">
                <div class="row2">
                    <div class="col-td">
                        <span class="chk-dsg"><input type="radio" id="is_upload1" name="is_upload" value="1" checked="checked"><label for="is_upload1">VOD 업로드</label></span>
...
<script>
    ...
    if (exhibition_status == 4) {
        ...
        window.location.replace("/exhibition/edit/<?=$exhibition_id?>");
    }
    //button alert  
    $(".btn-alert").hide();
