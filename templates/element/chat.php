...
<div class='msgln' style="line-height:120%;">
    ...
    <b style="opacity: 0.8; font-size: 14px;"><?php echo $list['user_name']; ?></b>
        <p style=" border:0; border-radius: 15px; height:fit-content; width: 100%; padding:8px 38px 7px 7px; background-color: #F0F0F0; word-break: keep-all;">
            <?php echo '<b class="user-name" style="word-break:break-all;  letter-spacing: 0.5px; margin:0; padding:0; font-weight: 500; background-color: inherit; color:black; line-height:1.5;">'.$list['message'].'</b>'; ?>
        </p>
